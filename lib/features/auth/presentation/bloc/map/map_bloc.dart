...
class MapBloc extends Bloc<MapEvent, MapState> {
  ...
  const LatLng(12.9920, 80.2350); // near pickup

  MapBloc(this.directionService, this.fareService)
      : super(MapState()) {
  ...
  void _startTracking(
      StartDriverTracking event, Emitter<MapState> emit) {
  ...
  void _updateDriver(
      UpdateDriverLocation event, Emitter<MapState> emit) {
